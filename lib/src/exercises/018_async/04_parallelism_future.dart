...
void main() {
  ...
  var totalLens = 0;
  var f1 = makeHttpGetRequest(url1).then((httpResp1) {
  ...
  var f2 = makeHttpGetRequest(url2).then((httpResp2) {
  ...
  var f3 = makeHttpGetRequest(url3).then((httpResp3) {
  ...
  var f4 = makeHttpGetRequest(url4).then((httpResp4) {
  ...
  var f5 = makeHttpGetRequest(url5).then((httpResp5) {
  ...
  var f6 = makeHttpGetRequest(url6).then((httpResp6) {
  ...
  var f7 = makeHttpGetRequest(url7).then((httpResp7) {
 ...
 // Future.wait(f1).then((value) => null);
...
Future<http.Response> makeHttpGetRequest(String url){
 // http.get(Uri.parse(url)).then((value) => value.body.length);
