...
void main() async {
  ...
  var httpResp1 = await makeHttpGetRequest(url1);
  ...
  var httpResp2 = await makeHttpGetRequest(url2);
  ...
  var httpResp3 = await makeHttpGetRequest(url3);
  ...
  var httpResp4 = await makeHttpGetRequest(url4);
  ...
  var httpResp5 = await makeHttpGetRequest(url5);
  ...
  var httpResp6 = await makeHttpGetRequest(url6);
  ...
  var httpResp7 = await makeHttpGetRequest(url7);
