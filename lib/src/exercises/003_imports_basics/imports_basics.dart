...
void importBuiltInLibrary() {
  ...
  stderr.writeln('THIS IS ERROR" to the "stderr');
}
...
Future<void> importPublicLibrary() async {
  ...
  var respDarteBodylength = respDart.body.length;
  print('response status code from Dart: $respDartStatusCode');
  print('response body length from Dart: $respDarteBodylength');

  print('Response body length from Dart is bigger on: '
      '${respDarteBodylength - respGoogleBodylength}');
}
